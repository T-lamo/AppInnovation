...
class ActionGiveHour(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        dispatcher.utter_message(Query_Db.retrieve_schedule_halfday(self=self,section_=str(tracker.get_slot("section")).upper(),grp_="classique",time_=str(now.hour) + ":" + str(now.minute)))
